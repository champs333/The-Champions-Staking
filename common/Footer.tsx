...
export const Footer = ({
  ...
  return (
    <div
      ...
      className="mt-20 px-10 pt-2 md:px-32"
      style={{
    ...
    >
     {/* <div className="flex w-full flex-wrap items-start justify-between gap-10 py-10">
        <div className="flex items-center"> */}
          {/* <img
            className="inline-block h-[100px]"
            src={
...
<div 
// className="flex w-full flex-wrap items-start justify-between gap-10 py-10"
// className="flex w-full flex-wrap items-start justify-between gap-2 py-10"
>
        <div className="flex items-center">
          <img
            className="inline-block h-[100px]"
