  ...
  return (
    <div>
      ...
      <div>
        ...
        >
          <div className="mt-10 mb-5 text-lg font-bold text-center">Stake Pools</div>
          <div className="grid grid-cols-1 gap-5 md:grid-cols-4" style={{display:"flex", justifyContent:"center"}}>
