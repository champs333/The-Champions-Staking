...
export const stakePoolMetadatas: StakePoolMetadata[] = [
  ...
  // {
  //   name: 'champion1',
  //   displayName: 'Champion_1',
  //   stakePoolAddress: new PublicKey(
  //     '82T6cwzhHZsG3LBoTdne8KbZYWyfy2HuASHQff6hh5k9'
  //   ),
  //   imageUrl: '/logo.png',
  //   colors: {
  //     primary: '',
  ...
  // {
  //   name: 'champion2',
  //   displayName: 'Champion_2',
  //   stakePoolAddress: new PublicKey(
  //     '67wvpdmwS3ms8GneBZYmRMTzcpnRUGB1egDbUYnKMJfK'
  //   ),
  //   imageUrl: '/logo.png',
  //   colors: {
  //     primary: '',
  ...
  {
    name:  'The Champions (33 per day)',
    displayName: 'The Champions (33 per day)',
    stakePoolAddress: new PublicKey(
      'bSpqRHUb9X2mQuPydSZa2QH6XLe9F2qa6ek6RHBFArp'
    ),
    imageUrl: '/logo.png',
    colors: {
      primary: '',
  ...
  {
    name: 'The Champions (66 per day)',
    displayName: 'The Champions (66 per day)',
    stakePoolAddress: new PublicKey(
      'CnYtgiWB73Kcm8VVXGqB4xpnB5udHXWagPPEwVtxfKTK'
    ),
    imageUrl: '/logo.png',
    colors: {
      primary: '',
